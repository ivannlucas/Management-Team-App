...
exports.updateUsuario = exports.getUsuariosByEquipo = exports.getUsuarioById = exports.getAllUsuarios = exports.deleteUsuario = exports.createUsuario = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _models["default"].usuarios.create(req.body);
        case 3:
          usuario = _context.sent;
          return _context.abrupt("return", res.status(200).json(usuario));
        case 7:
          _context.prev = 7;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _models["default"].usuarios.findAll();
        case 3:
 ...
 */
var getUsuariosByEquipo = exports.getUsuariosByEquipo = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var equipoId, usuarios;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          equipoId = parseInt(req.params.equipoId); // Convertir equipoId a número
        ...
        case 5:
          ...
          return _models["default"].usuarios.findAll({
            include: [{
              model: _models["default"].jugadores,
              as: 'jugadores',
              required: false,
              // Cambio a LEFT JOIN
              attributes: [],
              ...
              model: _models["default"].entrenadores,
              as: 'entrenadores',
              required: false,
              // Cambio a LEFT JOIN
              attributes: [],
            ...
            where: _defineProperty({}, _models["default"].Sequelize.Op.or, [{
              '$jugadores.usuario_id$': _defineProperty({}, _models["default"].Sequelize.Op.not, null)
            }, {
              '$entrenadores.usuario_id$': _defineProperty({}, _models["default"].Sequelize.Op.not, null)
            }]),
            attributes: ['id', 'nombre', 'apellidos', 'email', 'image_id', 'rol']
          });
        case 7:
          usuarios = _context3.sent;
          return _context3.abrupt("return", res.status(200).json(usuarios));
        case 11:
          _context3.prev = 11;
          _context3.t0 = _context3["catch"](0);
          console.log('Error al obtener usuarios por equipo: ', _context3.t0);
          return _context3.abrupt("return", res.status(400).json({
  ...
  return function getUsuariosByEquipo(_x5, _x6) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          _context4.prev = 3;
          _context4.next = 6;
          return _models["default"].usuarios.findByPk(id);
        case 6:
        ...
        case 9:
          return _context4.abrupt("return", res.status(200).json(usuario));
        case 12:
          _context4.prev = 12;
...
var updateUsuario = exports.updateUsuario = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var id, usuario, _req$body, nombre, apellidos, email, password, rol, isverified, image_id, fileBuffer, originalFileName, fileExtension, uniqueFileName, bucketName, folderPath, s3Response, updatedUsuario;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 9:
          _req$body = req.body, nombre = _req$body.nombre, apellidos = _req$body.apellidos, email = _req$body.email, password = _req$body.password, rol = _req$body.rol;
          isverified = req.body.isverified === 'true'; // Convertir a booleano
          image_id = usuario.imagen_id; // Mantener la URL existente si no hay nueva imagen
          if (!req.file) {
            _context5.next = 23;
            break;
          }
        ...
        case 23:
          _context5.next = 25;
          return _models["default"].usuarios.update({
            nombre: nombre,
            apellidos: apellidos,
            email: email,
            password: password,
        ...
        case 27:
          ...
          return _context5.abrupt("return", res.status(200).json(updatedUsuario));
        case 31:
          _context5.prev = 31;
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          _context6.prev = 3;
          _context6.next = 6;
          return _models["default"].usuarios.destroy({
            where: {
              id: req.params.id
            }
          });
