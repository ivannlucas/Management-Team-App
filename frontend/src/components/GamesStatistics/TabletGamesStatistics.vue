      ...
      <div class="col-6 pt-2" >
        <div class="card">
          ...
          <div class="row">
            ...
            <div class="col-12  input-class">
              <!-- <h5 class="mt-3">Tiros a puerta: {{ partido.estadisticas_partido.tiros_gol_equipo_local  }}</h5> -->
              <label class="label-class" for="horizontal2">Tiros a puerta:</label>
              <!-- <Slider v-model="partido.estadisticas_partido.tiros_gol_equipo_local" :step="1" :max="50"/> -->
              <InputNumber id="horizontal2" 
