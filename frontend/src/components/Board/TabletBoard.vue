  <template>
    <div>
      <h3 class="mt-2">  Crea tus propios entrenamientos</h3>
        ...
        methods: {
            ...
            mouse_down(event) {
                ...
                for (let textItem of this.textItems) {
                    if (this.isMouseInText(this.startX, this.startY, textItem)) {
                        ...
                        console.log("Texto seleccionado para mover:", textItem);
                        return;
                    }
                    index++;
                }
            ...
            stopDrawing(event) {
                if (this.isDrawing) {
                    ...
                    this.drawArrowHead(this.x, this.y, event.offsetX, event.offsetY);
            ...
            drawArrowHead(x1, y1, x2, y2) {
                ...
                this.canvasCtx.lineTo(x2 - headLength * Math.cos(angle - Math.PI / 6), y2 - headLength * Math.sin(angle - Math.PI / 6));
                this.canvasCtx.moveTo(x2, y2);
                this.canvasCtx.lineTo(x2 - headLength * Math.cos(angle + Math.PI / 6), y2 - headLength * Math.sin(angle + Math.PI / 6));
