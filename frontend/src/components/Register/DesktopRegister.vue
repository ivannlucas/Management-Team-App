        ...
        <div class="col-lg-7 col-xl-7 mx-auto">
          <div class="card flex-row  border-0  rounded-3 overflow-hidden">
            ...
            <div class="card-body p-2 p-sm-5">
              <h5 class="card-title text-center mb-4 fw-light fs-5">Crear cuenta como Entrenador</h5>
              <form @submit.prevent="handleCreateUser({name: nombre, apellidos: apellidos, email: email, password: pass1, rol: rol, nombre_equipo: nombre_equipo, edad: edad, anios_experiencia: anios_experiencia})">
                ...
                <div class="row">
                  <div class="col-6 mb-3 mt-2">
                    <label class="mr-3" for="edad">Edad</label>
                    <InputNumber class="m-2" id="edad" v-model="edad" mode="decimal" :min="16" :max="100" />
                  </div>
                  <div class="col-6 mb-3 mt-2">
