                    ...
                    <div class="pl-2 mt-2">
                        <div class="row">
                            <div class="col-4 text-center" >
                                <img
                                :src="user.usuario.photoURL || require('@/assets/cara1.png')"
                                alt="Avatar"
                        ...
                        <div class="row my-row">
                            ...
                            <div class="col-3 pt-0 mt-2 mb-2">
                                ...
                                <InputNumber 
                                    class=" profile-input " 
                                    id="numero_camiseta" 
                                    v-model="user.numero_camiseta"
                                    :value="user.numero_camiseta" 
                                    mode="decimal" 
                                    :min="0" 
                                    :max="99"
                                    :disabled="isDisabled"/>
                    ...
                    <div class="pl-2 mt-2">
                        <div class="row">
                            ...
                            <div class="col-4 text-center col-4-centered mt-2">
                                ...
                                <div>
                                    <label for="tarj_rojas" class="profile-label" style="margin-right: 1.5rem;"> Tarjetas Rojas </label>
